...
<head>
  ...
  <![endif]-->
        <script src="{{ asset('') }}backendend/assets/plugins/nprogress/nprogress.js"></script>
    </head>
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12 mb-4">
                                    <input id="name" class="form-control input-lg" type="text" name="name"
                                        :value="old('name')" required autofocus autocomplete="name"
                                        placeholder="Name">
                                </div>
                                <div class="form-group col-md-12 mb-4">
                                    <input id="email" class="form-control input-lg" type="email" name="email"
                                        :value="old('email')" required autocomplete="w" placeholder="Email">
                                </div>
