        ...
        <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item active"
                    style="background-image: url({{ asset('') }}fontend/assets/img/slide/slide-1.jpg);">
                ...
                <div class="carousel-item"
                    style="background-image: url({{ asset('') }}fontend/assets/img/slide/slide-2.jpg);">
                    <div class="carousel-container">
                        <div class="carousel-content animate__animated animate__fadeInUp">
                ...
                <!-- Slide 3 -->
                <div class="carousel-item"
                    style="background-image: url({{ asset('') }}fontend/assets/img/slide/slide-3.jpg);">
                    <div class="carousel-container">
                        <div class="carousel-content animate__animated animate__fadeInUp">
